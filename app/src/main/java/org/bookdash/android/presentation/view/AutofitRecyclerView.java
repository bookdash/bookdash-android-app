...
public class AutofitRecyclerView extends RecyclerView implements Scrollable {
    ...
    private SpanCountChangeListener spanCountChangeListener;
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (columnWidth > 0) {
            ...
            int previousSpanCount = manager.getSpanCount();
            manager.setSpanCount(spanCount);
            if (previousSpanCount != spanCount && spanCountChangeListener != null) {
                spanCountChangeListener.onSpanCountChange(spanCount, previousSpanCount);
            }
    ...
    public SpanCountChangeListener getSpanCountChangeListener() {
        return spanCountChangeListener;
    }

    public void setSpanCountChangeListener(SpanCountChangeListener spanCountChangeListener) {
        this.spanCountChangeListener = spanCountChangeListener;
    }
    ...
    public interface SpanCountChangeListener {
        void onSpanCountChange(int newSpan, int oldSpan);
    }
}
